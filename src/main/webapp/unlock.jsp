	...
	<div class="container padding-bottom-3x mb-2 mt-4">
		<div class="row justify-content-center">
			<div class="col-lg-8 col-md-10">
				...
				<form class="card mt-3" action="Email" method="POST">
					<div class="card-body">
					...
					<div class="card-footer">
						<button class="btn btn-success" type="submit">Get Email</button>
					</div>
				</form>
			</div>
		</div>
            <center> 
                <img src="check-your-email.gif" height="170px" width="290px" id="img">
    </center>
	</div>
